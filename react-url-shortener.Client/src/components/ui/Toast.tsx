...
const Toast = ({
  ...
  <div onTransitionEnd={() => onVisibilityChange?.(isVisible)} style={{ transitionDuration: `${transitionDuration}ms`, opacity: isVisible ? 1 : 0 }} className="bg-gradient-to-r from-gray-700 to-gray-900 z-[999] flex items-center w-full max-w-xs p-4 rounded-lg shadow-sm text-gray-400 transition-opacity"
    role="alert"
  >
    {GetToastIcon(type)}
